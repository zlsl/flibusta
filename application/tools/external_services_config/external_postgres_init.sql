-- parameters of the script FLIBUSTA_DBUSER FLIBUSTA_DBPASSWORD FLIBUSTA_DBNAME
--                                                                          

select :'FLIBUSTA_DBNAME' as DBNAME, :'FLIBUSTA_DBPASSWORD' as password, :'FLIBUSTA_DBUSER' as DBUSER;
                                                                        
create database :FLIBUSTA_DBNAME;                                           
create user :FLIBUSTA_DBUSER with encrypted password :'FLIBUSTA_DBPASSWORD';
grant all privileges on database :FLIBUSTA_DBNAME to :FLIBUSTA_DBUSER;
\connect :FLIBUSTA_DBNAME
grant all privileges on schema public to :FLIBUSTA_DBUSER;
